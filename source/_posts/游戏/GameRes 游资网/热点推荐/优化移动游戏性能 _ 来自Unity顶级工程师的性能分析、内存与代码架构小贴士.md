...
<br>
<div class="blockcode"><div id="code_E0n"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_E0n'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_W9U"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_W9U'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_cmd"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_cmd'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_S2P'));">复制代码</em></div><br>
